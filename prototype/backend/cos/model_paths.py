...
HF_LLAMA_7B_TEXT_DIR = f'{root_path}/models/llama-2-7b-hf/'
HF_LLAMA_13B_TEXT_DIR = f'{root_path}/models/llama-2-13b-hf/'
HF_LLAMA_7B_CHAT_DIR = f'{root_path}/models/llama-2-7b-chat-hf/'
HF_LLAMA_13B_CHAT_DIR = f'{root_path}/models/llama-2-13b-chat-hf/'
